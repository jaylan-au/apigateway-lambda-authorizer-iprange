...
/**
  TAKEN FROM: AWS Blueprint for AWS API Gateway Authorizer Function,
...
exports.handler = (event, context, callback) => {
    ...
    //Format into a range list for easier processing
    var authorizedRangeList = {
      apiAuthorized: authorizedIpRanges
    };
    ...
    if (sourceIpRange == 'unknown') {
      ...
      */
      ...
      //Allow all as all this function does it verify the user is in the Authorized IP Range
